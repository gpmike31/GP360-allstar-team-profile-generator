  ...
  return inquirer
    .prompt([
      ...
      },
      {
        ...
        validate: (nameInput) => {
          if (nameInput) {
            ...
            console.log(
              "You Must Provide Your Employee's first and last name in order to proceed."
            );
            return false;
          }
        },
      ...
      },
      {
        ...
        validate: (nameInput) => {
          if (nameInput) {
            ...
            console.log(
              "Employee's Github username must be entered here if applicable!"
            );
          }
        },
      },
      {
        ...
        name: "school",
        message:
          "Please enter the name of the University or Vocational school for the intern Here",
        ...
        validate: (nameInput) => {
          if (nameInput) {
            ...
            console.log(
              "The name of the Univerisity or Vocational school must be provided here!"
            );
          }
        },
      },
...
const writeFile = (data) => {
  fs.writeFile("./dist/index.html", data, (err) => {
    ...
    if (err) {
      ...
      console.log(
        "Your team profile has been successfully created! Please click on index.html to display information provided"
      );
    }
  });
};
